...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Kebijakan Pengembalian Dana — CoolService" },
      { name: "description", content: "Informasi lengkap mengenai kebijakan refund, pengembalian dana, pembatalan langganan, dan penyelesaian kendala pembayaran iPaymu di CoolService." },
      { property: "og:title", content: "Kebijakan Pengembalian Dana — CoolService" },
      { property: "og:description", content: "Informasi lengkap mengenai kebijakan refund, pengembalian dana, pembatalan langganan, dan penyelesaian kendala pembayaran iPaymu di CoolService." },
    ],
  }),
