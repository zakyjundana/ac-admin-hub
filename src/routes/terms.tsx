...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Syarat & Ketentuan Penggunaan — CoolService" },
      { name: "description", content: "Baca syarat dan ketentuan penggunaan platform SaaS CoolService untuk mengelola operasional bisnis servis AC di Indonesia secara tertib dan aman." },
      { property: "og:title", content: "Syarat & Ketentuan Penggunaan — CoolService" },
      { property: "og:description", content: "Baca syarat dan ketentuan penggunaan platform SaaS CoolService untuk mengelola operasional bisnis servis AC di Indonesia secara tertib dan aman." },
    ],
  }),
  component: TermsPage,
});
